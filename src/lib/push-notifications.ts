...
export const isPushNotificationSupported = () => pushNotifications.isSupported();

export const isPushNotificationEnabled = () => pushNotifications.isEnabled();

export const isPushNotificationBlocked = () => pushNotifications.isBlocked();

export const getPushNotificationStatus = () => pushNotifications.getStatusMessage();
