...
import { NewsletterSignup } from '@/components/blog/launchpad/NewsletterSignup';
import { LaunchpadHero } from '@/components/blog/launchpad/LaunchpadHero';
import { LaunchpadSidebar } from '@/components/blog/launchpad/LaunchpadSidebar';

export const metadata: Metadata = {
  title: 'Blog | GalaxyCo.ai',
          ...
          <section className="lg:col-span-2">
            <div className="flex items-center justify-between mb-6">
              ...
              {hasContent && posts.length > 6 && (
                <Link href="/blog/all" className="text-sm font-medium text-primary hover:text-primary/80 flex items-center gap-1">
