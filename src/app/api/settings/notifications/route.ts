...
export async function PUT(request: Request) {
  try {
    ...
    if (!validationResult.success) {
      return createErrorResponse(new Error('Validation failed: invalid input'), 'Update notification preferences error');
    }
    ...
    if (!userRecord) {
      return createErrorResponse(new Error('User not found'), 'Update notification preferences error');
    }
